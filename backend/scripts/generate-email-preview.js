  ...
  <div class="wrapper">
    <div class="card">
      ...
      <div class="content">
        ...
        <div class="detail"><div class="label">${labels.service}</div><div class="value">${sample.service}</div><div class="subvalue">${sample.serviceDuration} мин • € ${sample.servicePrice.toFixed(2)}</div></div>
