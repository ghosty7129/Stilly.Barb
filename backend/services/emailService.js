...
const getLabels = (language = 'bg') => {
  ...
  return {
    ...
    confirmationEmailNote: (email) => `Изпратен е потвърдителен имейл до вашата поща, който можете да очаквате до 5 минути! Моля, елате 5 минути по-рано за вашия час.`
  };
};
