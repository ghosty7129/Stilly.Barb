    ...
    <footer className="bg-primary text-white py-12">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div>
            <h3 className="font-display text-2xl font-bold mb-4">stilly.barb</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-neutral-400">
              ...
              <li className="mt-2">{t('saturdaySunday')}</li>
              <li className="text-white">{t('closed')}</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.facebook.com/stilly.barb/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-accent-gold transition-colors"
                aria-label="Facebook"
        ...
        <div className="border-t border-white/10 pt-8 text-center text-sm text-neutral-400">
          <p>{t('allRightsReserved')} © 2024 stilly.barb</p>
        </div>
      </div>
    </footer>
  )
